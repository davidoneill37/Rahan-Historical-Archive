...
<div data-role="page" id="info-page">
    ...
    <div data-role="content" id="content">		
        <ul data-role="listview" id="parish-list" data-filter="true"  data-input="#myFilter" data-divider-theme="a"  data-inset="true" >
        	<li data-theme="b" role="heading"><strong>Rahan Parish and School Records</strong></li>			
	...
	//alter here for change of data feed see also append list
        ...
        //store index value in array as id of the <a> tag
		 ...
		 if  (parish.Type_of_Record == "B"){
				list += '<li><a href="#" id="' + index + '" class="info-go">' + parish.Firstname + " " + parish.Lastname + " Event Year " +  parish.Date_Year   + " - Baptismal " + '</a></li>';
				};
		if  (parish.Type_of_Record == "M"){
				list += '<li><a href="#" id="' + index + '" class="info-go">' + parish.Lastname + " Event Year " +  parish.Date_Year   + " - Marriage " + '</a></li>';
				};
		if  (parish.Type_of_Record == "S") {
				list += '<li><a href="#" id="' + index + '" class="info-go">' + parish.Firstname + " " + parish.Lastname + " Date of Entry " +  parish.Date_Year  + " - Schools " + '</a></li>';
				};		
