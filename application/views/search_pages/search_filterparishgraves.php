...
<div data-role="page" id="info-page">
    ...
    <div data-role="content" id="content">		
        <ul data-role="listview" id="parish-list" data-filter="true"  data-input="#myFilter"  data-inset="true" >
        	<li  data-theme="b" role="heading"><strong>Parish and Graveyard Records</strong></li>			
...
$(document).on("pagecreate", "#info-page", function () {
	...
	//alter here for change of data feed see also append list
		...
		if (parish.Type_of_Record == "G") { 
				list += '<li><a href="#" id="' + index + '" class="info-go">' + parish.Firstname + " " + parish.Lastname + " Date of Death " +  parish.Date_Year  + " -  Graveyard" + '</a></li>';
				};		
		});
