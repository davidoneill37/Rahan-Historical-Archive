<body>
<!--Navbar code-->
<nav class="navbar navbar-fixed-top navbar-absolute navbar-transparent" id="navigationbar">
        ...
        <li class="dropdown">
            <a href="" class="menubutton" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="history">History<span class="caret"></span></a>
              <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>Sitecontrol/historyMain" id="history">History</a></li>
